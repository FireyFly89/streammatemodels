        ...
        <div class="site__header__content" id="site__navigation">
            <div class="site__header__actions__wrap">
                ...
                <div class="site__header__actions">
                    <a href="#join_us" class="btn--blue"><?php _e('WORD LID', 'streamatemodels'); ?></a>
                    <a href="https://www.streamatemodels.com/smm/login.php" class="btn--main"><?php _e('VERBINDING', 'streamatemodels'); ?></a>
                </div>
            </div>
