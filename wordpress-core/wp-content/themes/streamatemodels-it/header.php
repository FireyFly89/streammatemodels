...
<body <?php body_class(); ?>>
    ...
    <header class="site__header">
        <div class="site__header__content" id="site__navigation">
            <div class="site__header__actions__wrap">
                <ul class="site__header__actions__icons">
                    <li>
                        <a href="skype:live:.cid.fe49de07d2d0dd86?chat" class="site__header__actions__icons--small"><i class="fab fa-skype"></i>Contattaci subito tramite Skype!</a>
                        <a class="site__header__actions__icons--small" href="https://wa.me/352621419732" target="_blank">+352 621 419 732</a>
                        <a class="site__header__actions__icons--small" href="mailto:carmen@streamate.com">carmen@streamate.com</a>
                    </li>
                </ul>
                <div class="site__header__actions">
                    <a href="#hero" class="btn--blue"><?php _e('Registrati', 'streamatemodels'); ?></a>
                    <a href="https://www.streamatemodels.com/smm/login.php" class="btn--main"><?php _e('Accedi', 'streamatemodels'); ?></a>
                </div>
            </div>
        ...
        <div class="site__header__icons">
            <ul>
                <li>
                    <a href="skype:live:.cid.fe49de07d2d0dd86?chat" class="site__header__icons--meta"><i class="fab fa-skype"></i>Skype</a>
                    <a class="site__header__icons--meta" href="https://wa.me/352621419732" target="_blank">+352 621 419 732</a>
                    <a class="site__header__icons--meta" href="mailto:carmen@streamate.com">carmen@streamate.com</a>
                </li>
            </ul>
        </div>
    </header>
